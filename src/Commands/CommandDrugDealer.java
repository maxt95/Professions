...
public class CommandDrugDealer implements CommandExecutor {
	ArrayList<RPPlayer> onlinePlayers;
	public CommandDrugDealer(ArrayList<RPPlayer> onlinePlayers) {
